<div class="row-fluid ">
        ...
        ['plugin'=>'sys', 'controller'=>'settings', 'action' => 'edit'],
        ...
        ['plugin'=>'sys', 'controller'=>'settings', 'action' => 'modules'],
        ['class'=>'feature-box feature-icon img-thumbnail', 'escape'=>false]
        ) ?>
        ...
        ['plugin'=>'sys', 'controller'=>'settings', 'action' => 'update'],
        ['class'=>'feature-box feature-icon img-thumbnail', 'escape'=>false]
        ) ?>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php if (empty($settings)): ?>
                <li class="alert alert-block alert-danger"> O cache não está funcionando. Verifique as configurações em config /sys.php</li>
            <?php endif; ?>
            <?php
            try {
